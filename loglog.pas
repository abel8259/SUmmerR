...
{Intuito:gerar o log a receber a cópia dos comandos====================}
{======================================================================}
{data: 220422==========================================================}
...
{VAZIO}
    ...
    {VAZIO} 
	{INICIO-BLOCO}
		procedure Menuloglogg();{identificador do procedimento} 
    {FIM-BLOCO}
	{VAZIO} 
	{VAZIO}
	{EXPLICAÇAO:  
	...
	{implementaçao de código} 
	    ...
	    {EXPLICAÇAO:  
            ...
            * }    
            {VAZIO} 
            {INICIO-BLOCO}
				procedure Menuloglogg();{inicio do procedimento}
			{FIM-BLOCO}
            {VAZIO} 
            {VAZIO} 
            {EXPLICAÇAO:  
